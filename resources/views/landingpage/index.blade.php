...
<head>
  ...
  <!-- 
    - flaticon
  -->
  <link rel="stylesheet" href="asset2/css/flaticon.min.css">

  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="./asset2/images/hero-banner.jpg">
      ...
      <div class="container">
        ...
        <ul class="header-top-list">
          ...
          <li class="header-top-item">
            ...
            <a href="tel:01234567895" class="item-link">089xxxxxxxxxx</a>
          </li>
          ...
          <li class="header-top-item">
            ...
            <p class="item-text">Monday - Saturday, 11 am - 08 pm</p>
          </li>
      ...
      <section class="section hero has-before has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <div class="btn-container">
            ...
            <a href="#" class="btn has-before">
              <span class="span">Try Our AI Hairstyle</span>
              <ion-icon name="arrow-forward" aria-hidden="true"></ion-icon>
            </a>
          </div>
        </div>
...
<!-- #HAIR TRENDS -->
<section class="section hair-trends" id="hair-trends" aria-label="hair trends">
  <div class="container">
    <h2 class="h2 section-title text-center">Latest Hair Trends</h2>
    <div class="trends-slider">
      <button class="slide-btn left" onclick="slideLeft()">❮</button>
      <div class="trends-container">
        <!-- Slide 1 -->
        <div class="trend-card">
          <img src="./asset2/images/gallery-1.jpg" alt="Trendy Cut 1" class="trend-image">
        </div>
        <!-- Slide 2 -->
        <div class="trend-card">
          <img src="./asset2/images/gallery-2.jpg" alt="Trendy Cut 2" class="trend-image">
        </div>
        <!-- Slide 3 -->
        <div class="trend-card">
          <img src="./asset2/images/gallery-3.jpg" alt="Trendy Cut 3" class="trend-image">
        </div>
        <div class="trend-card">
          <img src="./asset2/images/gallery-4.jpg" alt="Trendy Cut 4" class="trend-image">
        </div>
        <div class="trend-card">
          <img src="./asset2/images/gallery-3.jpg" alt="Trendy Cut 3" class="trend-image">
        </div>
      ...
      <section class="section pricing has-bg-image has-before" id="pricing" aria-label="pricing"
        style="background-image: url('./asset2/images/pricing-bg.jpg')">
        <div class="container">
            ...
            <ul class="grid-list">
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-1.jpg" width="90" height="90" alt="Hair Cutting & Fitting"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-2.jpg" width="90" height="90" alt="Shaving & Facial"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="face-washing">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-3.jpg" width="90" height="90" alt="Hair Color & Wash"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="body-treatments">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-4.jpg" width="90" height="90" alt="Body Massage"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="beauty-spa">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-5.jpg" width="90" height="90" alt="Beauty & Spa"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="face-washing">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-6.jpg" width="90" height="90" alt="Facial & Face Wash"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="body-treatments">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-7.jpg" width="90" height="90" alt="Backbone Massage"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="meditations">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="./asset2/images/pricing-8.jpg" width="90" height="90" alt="Meditation & Massage"
                      class="img-cover">
                  </figure>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./asset2/images/gallery-1.jpg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./asset2/images/gallery-2.jpg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./asset2/images/gallery-3.jpg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="./asset2/images/gallery-4.jpg" width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
        ...
        <div class="container">
          ...
          <div class="appoin-card">
            ...
            <figure class="card-banner img-holder" style="--width: 250; --height: 774;">
              <img src="./asset2/images/appoin-banner-1.jpg" width="250" height="774" loading="lazy" alt=""
                class="img-cover">
            </figure>
            ...
            <figure class="card-banner img-holder" style="--width: 250; --height: 774;">
              <img src="./asset2/images/appoin-banner-2.jpg" width="250" height="774" loading="lazy" alt=""
                class="img-cover">
            </figure>
  ...
  <footer class="footer has-bg-image" style="background-image: url('./asset2/images/footer-bg.png')">
    <div class="container">
          ...
          <ul class="footer-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 70; --height: 75;">
                  <img src="./asset2/images/footer-blog-1.jpg" width="70" height="75" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 70; --height: 75;">
                  <img src="./asset2/images/footer-blog-2.jpg" width="70" height="75" loading="lazy"
  ...
  <!-- 
    - custom js link
  -->
  <script src="./asset2/js/script.js" defer></script>
