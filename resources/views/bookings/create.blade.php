                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item">
                                <div class="team-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="{{ asset('storage/' . $barber->user->profile) }}"
                                        alt="Image">
                                    <div class="team-social">
                                        <a class="btn btn-primary"
                                            href="{{ route('barber.profile', $barber->id) }}">view profile</a>
                                </div>
                            </div>
                            <div class="bg-secondary
                                            ...
                                            <button type="button" class="btn btn-primary select-barber"
                                                data-barber-id="{{ $barber->id }}">Pilih</button>
                                    </div>
                                </div>
                            </div>
                    @endforeach
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, schedule) {
                            $('#booking_date').append('<option value="' + schedule
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, service) {
                            $('#service_id').append('<option value="' + service.id +
                                '" data-price="' + service.price + '">' + service
                                .name + '</option>');
                        });
                    },
                    error: function(xhr, status, error) {
